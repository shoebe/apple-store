...
public class ProductQuantityCollection {
    ...
    /**
     * Constructor for app.ProductQuantityCollection
     */
    ...
    /**
     * Returns a app.Product object which has the associated product ID.
     * If no app.Product in the collection has that product ID, returns null.
     * @param productID the ID associated with the desired app.Product object
     * @return the app.Product object
     */
    ...
    /**
     * Checks whether or not a app.Product in this collection is associated with the given productID
     * @param productID the productID of the product
     * @return true if the productID is associated with a app.Product in this collection
     */
    ...
    /**
     * Removes a product and its associated quantity from the collection, if they are in the collection.
    ...
    /**
     * Returns the amount of product currently in this collection
     * @return the number of products in the collection
     */
