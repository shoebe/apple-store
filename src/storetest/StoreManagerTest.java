...
public class StoreManagerTest {
    ...
    void createNewCart() {
        ...
        assertDoesNotThrow(() -> sm.getCartItemCount(id), "SM does not keep track of newly created cart");
        assertThrows(IllegalArgumentException.class, () -> sm.getCartItemCount("invalid ID"), "SM has a cart with an invalid ID");
    ...
    void removeCart() {
        String cID = sm.createNewCart();
        sm.removeCart(cID);
        assertThrows(IllegalArgumentException.class, () -> sm.getCartItemCount("invalid ID"), "SM still keeping track of cart after removal");
    }
